function limpiar(){
    document.getElementById("Nota1").value="";//Borrar todo en cuadro tecto Nota1
    document.getElementById("Nota2").value="";//Borrar todo en cuadro tecto Nota1
    document.getElementById("Nota3").value="";//Borrar todo en cuadro tecto Nota1
    document.getElementById("Definitiva").value="";//Borrar todo en cuadro tecto Nota1
}
function promedio(){
